...
**—  —  —  —  —  —  —  —  —  —**""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "‹ قناة الشروحات ›", url=f"https://t.me/N_B_100"
                    ),
                    InlineKeyboardButton(
...
▫️ ** اي مشكلة تواجها لاتتردد في التحدث مع المطور: @N_B_1**
...
» - لتفعيل الكت ارسل /تفعيل كت
» - لتعطيل الكت ارسل /تعطيل كت
✶ Dev - @{OWNER_NAME}**""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
...
async def cbbasic(_, query: CallbackQuery):
    ...
    await query.edit_message_text(
        f"""**✶ اوامر الاعضاء ↓
 - - - [ اوامر التشغيل ] 
➥•  /play + /تشغيل ( اسم الاغنيه او بالرد )
➥• /vplay + /فيديو ( اسم الفيديو - بالرد )
➥• /playlist + /قائمه التشغيل - لعرض قائمة الانتظار
- - - [ اوامر البث المباشر ]
➥•  /stream + ( رابط البث ) ~ صوت
 ➥• /vstream + ( رابط البث ) ~ بث
- - - [ اوامر التحميل ]
➥• /song + /بحث ( اسم الصوت - الاغنيه )
➥• /vsong + /فيد ( اسم الفيديو )
➥• /search + /رابط ( اسم الاغنيه او المقطع ) ~ يعطيك روابط له 
- - - [ اوامر المجموعة ]
➥• /ping + /بنك - لعرض سرعة البوت
➥• /uptime + /حدث - لعرض حالة البوت
➥• /alive + /فحص - لعرض قاعدة البيانات
✶ 𝗠𝗮𝘀𝘁𝗲𝗿 - @{OWNER_NAME}**""",
        reply_markup=InlineKeyboardMarkup(
...
➥ /pause +/توقف - لايقاف مؤقت
➥ /resume - لاكمال التشغيل
➥ /mute + /كتم - لكتم الصوت 
➥ /unmute +/الغاء كتم - لرفع الكتم
➥ /vmute - لكتم الفيديو 
➥ /vunmute - لالغاء كتم الفيديو
- - - [اوامر البوت + الحساب المساعد ]
➥ /reload + /تحديث - لتحديث البوت 
➥ {AMR_NAME} انضم - لدعوة الحساب المساعد للمجموعة
➥ {AMR_NAME} غادر - لطرد الحساب المساعد من المجموعة
✶ 𝗠𝗮𝘀𝘁𝗲𝗿 - @{OWNER_NAME}**""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("‹ رجوع ›", callback_data="ck")]]
        ),
